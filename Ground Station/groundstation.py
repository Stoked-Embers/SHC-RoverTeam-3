...
"")
        ...
        self.armDiagram.setGeometry(QtCore.QRect(90, -40, 311, 421))
        self.armDiagram.setText("")
        self.armDiagram.setPixmap(QtGui.QPixmap("../../../../Downloads/SHC-RoverTeam-3-main/SHC-RoverTeam-3-main/Ground Station/Arm Diagram for Ground station V1.png"))
        ...
        self.controlsDiagram.setPixmap(QtGui.QPixmap("../../../../Downloads/SHC-RoverTeam-3-main/SHC-RoverTeam-3-main/Ground Station/xboxmap.png"))
        ...
        self.graphicsView_1 = QtWidgets.QGraphicsView(self.data1Frame)
        self.graphicsView_1.setGeometry(QtCore.QRect(0, 0, 250, 170))
        self.graphicsView_1.setStyleSheet("background-color: rgb(168, 168, 168);")
        ...
        self.graphicsView_2 = QtWidgets.QGraphicsView(self.data2Frame)
        self.graphicsView_2.setGeometry(QtCore.QRect(0, 0, 250, 170))
        self.graphicsView_2.setStyleSheet("background-color: rgb(168, 168, 168);")
